...
SRC_URI="https://github.com/roboception-gbp/${PN}-release/archive/release/kinetic/${PN}/3.0.1-1.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-kinetic/rc_silhouettematch_client
