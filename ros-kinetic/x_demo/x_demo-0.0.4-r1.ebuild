...
SRC_URI="https://github.com/HebiRobotics/hebiros-release/archive/release/kinetic/${PN}/0.0.4-1.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"

LICENSE="BSD"

KEYWORDS="~x86 ~amd64 ~arm ~arm64"
RDEPEND="
	ros-kinetic/hebiros_description
