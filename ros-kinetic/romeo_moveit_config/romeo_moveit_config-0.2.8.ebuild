...
SRC_URI="https://github.com/ros-aldebaran/romeo_moveit_config-release/archive/release/kinetic/romeo_moveit_config/0.2.8-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
