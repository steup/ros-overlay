...
SRC_URI="https://github.com/ros2-gbp/ros2cli-release/archive/release/eloquent/${PN}/0.8.7-1.tar.gz -> ${PN}-eloquent-release-${PV}.tar.gz"
...
RDEPEND="
	...
	test? ( ros-eloquent/ros2lifecycle_test_fixtures )
