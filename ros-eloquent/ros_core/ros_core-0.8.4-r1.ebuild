...
SRC_URI="https://github.com/ros2-gbp/variants-release/archive/release/eloquent/${PN}/0.8.4-1.tar.gz -> ${PN}-eloquent-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-eloquent/ros2doctor
	ros-eloquent/ros2interface
