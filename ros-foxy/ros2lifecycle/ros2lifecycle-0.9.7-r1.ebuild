...
SRC_URI="https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/${PN}/0.9.7-1.tar.gz -> ${PN}-foxy-release-${PV}.tar.gz"
...
RDEPEND="
	...
	test? ( ros-foxy/ros2lifecycle_test_fixtures )
