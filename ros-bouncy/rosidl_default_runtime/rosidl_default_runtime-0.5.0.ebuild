...
SRC_URI="https://github.com/ros2-gbp/rosidl_defaults-release/archive/release/bouncy/${PN}/0.5.0-0.tar.gz -> ${PN}-bouncy-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-bouncy/rosidl_generator_py
