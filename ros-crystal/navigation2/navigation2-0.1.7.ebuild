...
SRC_URI="https://github.com/SteveMacenski/${PN}-release/archive/release/crystal/${PN}/0.1.7-0.tar.gz -> ${PN}-crystal-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-crystal/nav2_motion_primitives
